...
demux/demux_vcf: src/demux_vcf.cpp src/robin_hood.h src/nnls.h build/nnls.o build/common.o
...
demux/demux_mt: src/demux_mt.cpp src/robin_hood.h src/common.h build/common.o 
...
utils/bam_indiv_rg: src/bam_indiv_rg.cpp build/common.o
	$(COMP) $(IFLAGS) $(LFLAGS) $(FLAGS) src/bam_indiv_rg.cpp -o utils/bam_indiv_rg build/common.o -lhts -lhtswrapper

utils/bam_split_bcs: src/bam_split_bcs.cpp build/common.o
