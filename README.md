...
|------------|---------|-----------|
| <div style="float: left; width=50px; display: table-cell" ><img src="img/demux_species.png" width=50 alt="demux_species" /> </div> <div style="padding-left: 25px; float: left; display: table-cell" > Demultiplex cells by **species** </div> |Raw reads, plus a transcriptome (FASTA) or annotation (GTF) and genome (FASTA) per species <p align="center">*OR*</p> A BAM file of reads mapped to a composite reference genome|[`demux_species`](#demux_species)|
