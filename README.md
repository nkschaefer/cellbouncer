...
|------------|---------|-----------|
| <img src="img/demux_species.png" width=50 alt="demux_species" /> and text | Demultiplex cells by **species** |Raw reads, plus a transcriptome (FASTA) or annotation (GTF) and genome (FASTA) per species <p align="center">*OR*</p> A BAM file of reads mapped to a composite reference genome|[`demux_species`](#demux_species)|
